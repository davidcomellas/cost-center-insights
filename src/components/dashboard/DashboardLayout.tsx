...
const DashboardLayout = ({
  ...
  return (
    <div className="min-h-screen bg-background print:bg-card">
      {/* A4 Page Container */}
      <div className="mx-auto max-w-[210mm] min-h-[297mm] bg-card shadow-xl print:shadow-none flex flex-col">
        {/* Header */}
        ...
        <footer className="border-t border-border px-6 py-3 flex items-center justify-between flex-shrink-0 print:hidden">
